...
<head>
	...
	<script>
		$(document).ready(function(){
			...
			toggleRoleForm(); // 초기 실행

			$("#m_role").change(function(){
				toggleRoleForm();
			});
	...
	<form action="${contextPath}/member/addMember.do" method="POST" id="form">
		<table>
			<tbody>
				...
				<tr class="dot_line" id="personalForm">
					<td class="fixed_join">주민등록번호</td>
					<td><input type="text" name="m_birth" size="20" /> - <input type="text" name="m_gender" size="1" />******</td>
				</tr>

				<tr class="dot_line" id="businessForm" style="display:none;">
					<td class="fixed_join">사업자등록번호</td>
					<td><input type="text" name="business_number" size="20" placeholder="123-45-67890 형식" /></td>
				</tr>
				<tr class="dot_line" id="businessForm" style="display:none;">
					<td class="fixed_join">상호명</td>
					<td><input type="text" name="company_name" size="20" /></td>
				</tr>
				<tr class="dot_line" id="businessForm" style="display:none;">
					<td class="fixed_join">업종</td>
					<td><input type="text" name="business_type" size="20" /></td>
				</tr>
